...
> **Antigravity platform:** Antigravity's Manager View dispatches agents from the human side, not programmatically from within an agent session. Extraction runs sequentially — you read and extract each file yourself. This is slower than parallel platforms but fully reliable.

Print: `"Semantic extraction: N files (sequential — Antigravity)"`
...
**Step B2 - Sequential extraction (Antigravity)**
