"""LanguageConfig instances and extra walk functions for all supported languages."""
from __future__ import annotations

from ._base import LanguageConfig, _make_id, _read_text
from ._imports import (
    _import_python, _import_js, _import_java, _import_c,
    _import_csharp, _import_kotlin, _import_scala, _import_php,
    _import_lua, _import_swift,
)
