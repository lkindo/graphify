...
**Step B2 - Dispatch ALL subagents in a single message (Droid Task tool)**

> **Droid platform:** Use the `Task` tool with `subagent_type="worker"` (or equivalent worker-task invocation) for parallel extraction.
