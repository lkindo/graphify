---
name: graphify-antigravity-windows
...
> **Antigravity platform:** Multi-agent support is still early on Antigravity. Extraction runs sequentially — you read and extract each file yourself. This is slower than parallel platforms but fully reliable.
