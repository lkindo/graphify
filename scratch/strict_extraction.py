...
def strict_mechanical_extraction():
    ...
    # TOC page numbers exactly as written in the book
    mapping = [
    ...
    for item in mapping:
        ...
        # This results in extracting PDF page (TOC_NUM + 1) and (TOC_NUM + 2).
        page_idx = item["page"] 
    ...
    doc.close()
    print(f"Successfully re-extracted {len(mapping)} entries using STRICT TOC page numbers.")

if __name__ == "__main__":
    strict_mechanical_extraction()
