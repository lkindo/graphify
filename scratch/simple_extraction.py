...
def simple_mechanical_extraction():
    ...
    # Original TOC page numbers (as written in the book's TOC)
    mapping = [
        ...
        {"name": "노각나무", "page": 334}, {"name": "차나무", "page": 336}, {"name": "두충", "page": 341}, 
    ...
    doc.close()
    print(f"Successfully re-extracted {len(mapping)} entries using mechanical TOC+1/TOC+2 rule.")

if __name__ == "__main__":
    simple_mechanical_extraction()
